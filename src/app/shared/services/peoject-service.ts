...
export class ProjectService {
  ...
  getProjectUnitDescriptionsList(projectId:any):Observable<any>{
    let params = new HttpParams();
    params = params.append('projectId', projectId);
    return this._httpClient.get<any>(environment.apiUrl + "/Project/GetProjectUnitDescriptionsList", { params: params});
  } 
  ...
  saveReservation(Project: any):Observable<ResponseData>{
    return this._httpClient.post<any>(environment.apiUrl + "/Project/SaveReservation", Project);
  } 

  getProjectUnitList(projectId:any):Observable<any>{
    let params = new HttpParams();
    params = params.append('projectId', projectId);
    return this._httpClient.get<any>(environment.apiUrl + "/Project/GetProjectUnitList", { params: params});
  } 
  getUnitDescriptionsByUnti(floorNumber:any,projectId:any):Observable<any>{
    let params = new HttpParams();
    params = params.append('floorNumber', floorNumber);
    params = params.append('projectId', projectId);
    return this._httpClient.get<any>(environment.apiUrl + "/Project/GetUnitDescriptionsByUnti", { params: params});
  } 
}
